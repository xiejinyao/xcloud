...
import com.xjinyao.xcloud.test.annotation.WithMockOAuth2User;
...
public class WithMockSecurityContextFactory implements WithSecurityContextFactory<WithMockOAuth2User> {
    ...
    private OAuth2Authentication getUser(String token) {
        CustomRemoteTokenServices tokenServices = SpringContextHolder.getBean(CustomRemoteTokenServices.class);
