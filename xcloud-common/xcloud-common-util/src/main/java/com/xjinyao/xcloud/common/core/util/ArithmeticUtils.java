 ...
 * @createDate 2022/12/14 09:07
 */
public class ArithmeticUtils {

    //默认除法运算精度
    private static final int DEF_DIV_SCALE_TEN = 10;
    ...
    public static BigDecimal mul(BigDecimal v1, BigDecimal v2) {
        return v1.multiply(v2).setScale(DEF_DIV_SCALE_TWO, RoundingMode.HALF_UP);
    }
    ...
    public static BigDecimal div(BigDecimal v1, BigDecimal v2) {
        return v1.divide(v2, DEF_DIV_SCALE_TWO, RoundingMode.HALF_UP);
    }
