...
<head>
    ...
    <!-- DataTables -->
    <link rel="stylesheet"
          href="${basePath}/static/adminlte/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
...
<!-- moment -->
<script src="${basePath}/static/adminlte/bower_components/moment/moment.min.js"></script>
<#-- cronGen -->
<script src="${basePath}/static/plugins/cronGen/cronGen<#if I18n.admin_i18n?default('')?length gt 0 >_${I18n.admin_i18n}</#if>.js"></script>
<script src="${basePath}/static/js/jobinfo.index.1.js"></script>
</body>
</html>
