...
<head>
    ...
    <link rel="stylesheet" href="${basePath}/static/plugins/codemirror/lib/codemirror.css">
    <link rel="stylesheet" href="${basePath}/static/plugins/codemirror/addon/hint/show-hint.css">
...
<@netCommon.commonScript />
    ...
    <script src="${basePath}/static/plugins/codemirror/lib/codemirror.js"></script>
    <script src="${glueTypeModeSrc}"></script>
<#if glueTypeModeSrc02?exists>
    <script src="${glueTypeModeSrc02}"></script>
</#if>
    <script src="${basePath}/static/plugins/codemirror/addon/hint/show-hint.js"></script>
    <script src="${basePath}/static/plugins/codemirror/addon/hint/anyword-hint.js"></script>

    <script>
        var id = '${jobInfo.id}';
var ideMode = '${glueTypeIdeMode}';
    </script>
    <script src="${basePath}/static/js/jobcode.index.1.js"></script>
