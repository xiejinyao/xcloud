...
<#-- favicon -->
	...
	<!-- Bootstrap -->
	<link rel="stylesheet" href="${basePath}/static/adminlte/bower_components/bootstrap/css/bootstrap.min.css">
	<!-- Font Awesome -->
	...
	<!-- pace -->
	<link rel="stylesheet" href="${basePath}/static/adminlte/bower_components/PACE/themes/blue/pace-theme-flash.css">
...
<#macro commonScript>
	<!-- jQuery -->
	<script src="${basePath}/static/adminlte/bower_components/jquery/jquery.min.js"></script>
	<!-- Bootstrap -->
	<script src="${basePath}/static/adminlte/bower_components/bootstrap/js/bootstrap.min.js"></script>
	<!-- FastClick -->
	<script src="${basePath}/static/adminlte/bower_components/fastclick/fastclick.js"></script>
	<!-- AdminLTE App -->
	...
	<!-- pace -->
	<script src="${basePath}/static/adminlte/bower_components/PACE/pace.min.js"></script>
<#-- jquery cookie -->
...
<#-- common -->
	<script src="${basePath}/static/js/common.1.js"></script>
	<script>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "index">active</#if>"><a href="./"><i
...
<#macro commonFooter >
	<footer class="main-footer">
		Powered by <b>XCLOUD-JOB</b> ${I18n.admin_version}
